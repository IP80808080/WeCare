...
export default function AdminDashboard({
  ...
  const sidebarItems = [
    { icon: RiAdminLine, label: "Admin Dashboard", value: "Admin Dashboard" },
    { icon: GrUpdate, label: "Update", value: "Update" },
            ...
            <DropdownMenu>
              ...
              >
                ...
                <DropdownMenuItem className="hover:bg-gray-800">
                  ...
                  <Link href={`/admin-dashboard/profile/${userId}`}>
                    Profile
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem className="hover:bg-gray-800">
                  <Settings className="mr-2 h-4 w-4" />
                  <Link href={`/admin-dashboard/settings/${userId}`}>
                    Settings
                  </Link>
                </DropdownMenuItem>
              </DropdownMenuContent>

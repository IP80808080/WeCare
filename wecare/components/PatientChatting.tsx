...
const doctors = [
  ...
  },
  {
    ...
    reason: "skin rash",
    avatar: "/assets/icons/placeholder.png?height=40&width=40",
    lastMessage: "The rash seems to be spreading to my arms.",
  },
  {
    id: 3,
    name: "Emma Wilson",
    reason: "migraines",
    avatar: "/assets/icons/placeholder.png?height=40&width=40",
    lastMessage: "When should I start the new medication?",
  },
  {
    id: 4,
    name: "James Anderson",
    reason: "fever",
    avatar: "/assets/icons/placeholder.png?height=40&width=40",
    lastMessage: "The fever hasn't gone down yet.",
  },
  {
    id: 5,
    name: "Linda Martinez",
    reason: "surgery",
    avatar: "/assets/icons/placeholder.png?height=40&width=40",
    lastMessage: "When can I resume normal activities?",
  },
];
          ...
          {doctors.map((doctor) => (
            ...
            >
              ...
              <div className="ml-4">
                ...
                <p className="text-xs text-gray-400">{doctor.reason}</p>
      ...
      <div className="flex-grow flex flex-col ">
        <div className="p-4  flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-sm text-gray-400">{selectedDoctor.reason}</p>
          </div>
        </div>
